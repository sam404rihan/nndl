            ...
            <div className="mb-6">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 font-mono mt-1">Patient ID: {patient.patient_no || patient.id.slice(0, 8)}</p>
                    </div>
                    <Link
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                {request.order_tests && request.order_tests.length > 3 && (
                                                    <span className="px-2 py-1 bg-slate-200 border border-slate-400 rounded text-xs font-bold text-slate-800">
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        <div className="p-6 overflow-y-auto flex-1">
                            ...
                            <div>
                                ...
                                <div className="border border-slate-200 rounded-lg overflow-hidden max-h-[400px] overflow-y-auto" style={{
                                    scrollbarWidth: 'thin',
